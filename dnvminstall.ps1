...
$webClient.DownloadFile('https://raw.githubusercontent.com/brandonmartinez/Aspnet-Home/dev/dnvm.ps1', $dnvmPs1Path)
Write-Host "Downloading DNVM.cmd to $dnvmCmdPath"
$webClient.DownloadFile('https://raw.githubusercontent.com/brandonmartinez/Aspnet-Home/dev/dnvm.cmd', $dnvmCmdPath)
